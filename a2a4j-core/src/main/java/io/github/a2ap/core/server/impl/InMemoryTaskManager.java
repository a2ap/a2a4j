...
/**
 * In-memory implementation of the TaskManager interface. This implementation stores all
 * tasks in memory and is suitable for testing and demonstration purposes.
 */
public class InMemoryTaskManager implements TaskManager {
	...
	public Mono<Task> applyArtifactUpdate(Task task, TaskArtifactUpdateEvent event) {
		...
		if (!appendParts) {
			...
			log.warn("Received append=true for nonexistent artifact id {} in task {}. Ignoring chunk.", artifactId,
					task.getId());
		}
