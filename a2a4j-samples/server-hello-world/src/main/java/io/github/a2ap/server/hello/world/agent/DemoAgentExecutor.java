...
/**
 * <<<<<<<
 * HEAD:a2a4j-core/src/main/java/io/github/a2ap/core/server/impl/DemoAgentExecutor.java
 * Demo implementation of AgentExecutor that simulates various types of events during task
 * execution, including status updates, progress reports, and artifact generation. =======
 ...
 * origin/main:a2a4j-samples/server-hello-world/src/main/java/io/github/a2ap/server/hello/world/agent/DemoAgentExecutor.java
 */
@Component
